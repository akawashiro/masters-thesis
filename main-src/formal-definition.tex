...
\cite{attapl}, all uses of conversion rules in dependent type system can be
move into application rules. This is because application rules check the type
...
\AK{I simplified the definition of algorithmic reduction by removing the
concept of level \( n \) subterms. Should I include it?}
...
\begin{figure}[tbp]
    \begin{center}
        ...
        \end{align*}
        And take the congruence on terms.
    \end{center}
