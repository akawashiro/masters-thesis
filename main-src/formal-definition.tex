...
Algorithmic typing is almost the same with original typing rules threfore there
...
from judegements of the original typing and omit kinds and types from typing
...
corresponds to \QPercent in the normal term equivalence rules.
