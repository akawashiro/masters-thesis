...
Then, we prove the relationship between one step algorithmic reduction and substitution.
...
of Algorithmic Judgement (Lemma
\ref{lemma:TermSubstitutionLemmaofAlgorithmicJudgement}). In \cite{attapl},
they use weak head normal form but we changed it to normal form. This is
because we couldn't prove this lemma for weak head normal form.
