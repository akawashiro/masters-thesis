...
presevation of algorithmic reduction.
...
\begin{proof}
    ...
    equivalence presevation lemma and use them. The diffirent case is
...
Because algorithmic typing is defined mutally involving other algorithmic
...
symmetricity, reflexivity and transitiviy of algorithmic typing which are
