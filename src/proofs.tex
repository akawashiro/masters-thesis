...
\begin{theorem}[Preservation on $\beta$-Reduction]
    \label{theorem:PreservationOnBetaReduction}
...
\begin{theorem}[Preservation on $\blacklozenge$-Reduction]
    \label{theorem:PreservationOnBlackReduction}
...
\begin{theorem}[Preservation on $\Lambda$ Reduction]
    \label{theorem:PreservationOnLambdaReduction}
...
\begin{corollary}[Preservation on level 0 reduction]
    If \( \G \V M : \tau @ A \) and \( M \longrightarrow_0 M' \), then \( \G \V M' : \tau @ A \).
\end{corollary}

\begin{proof}
    We can get as a corollary of Theorem \ref{theorem:PreservationOnBetaReduction}, \ref{theorem:PreservationOnBlackReduction}, and \ref{theorem:PreservationOnLambdaReduction}.
\end{proof}
